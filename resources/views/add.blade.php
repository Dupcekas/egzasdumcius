...
<form action="/create" method="POST">
  ...
  <div class="form-outline mb-4">
    <input type="text" id="form6Example3" name="price" class="form-control" />
  ...
  <div class="form-check d-flex justify-content-center mb-4">
    <textarea class="form-check-input me-2" type="checkbox" value="" name="description" id="form6Example8" checked />
